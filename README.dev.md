...
rm -rf data_processing.egg-info
rm -rf dist
...
Visit
[https://test.pypi.org/project/data_processing](https://test.pypi.org/project/data_processing)
and verify that your package was uploaded successfully. Keep the terminal open, we'll need it later.

In a new terminal, without an activated virtual environment or an env directory:

```shell
cd $(mktemp -d --tmpdir data_processing-test.XXXXXX)
...
--extra-index-url https://pypi.org/simple data_processing
```
